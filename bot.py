...
async def approve(_, m: Message):
    ...
    try:
        ...
        await app.send_video(kk.id, img, "**Hello {}😈💜!\nYour request to join🤩 channel {} has been approved✅.keeps sharing and support us🫠🥹\n\n__Powerd By : #TEAMKannada 😎🔥**".format(m.from_user.mention, m.chat.title), reply_markup=InlineKeyboardMarkup(btn))
        add_user(kk.id)
...
async def op(_, m: Message):
    try:
        ...
        key = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🍀 Private 🍀", "chk")
                ]
            ]
        )
        await m.reply_text("**⚠️Access Denied!⚠️\n\nPlease Join @{}.**".format(cfg.FSUB), reply_markup=key)
...
async def chk(_, cb: CallbackQuery):
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**👋 Hello {}!\nI'M AUTO JOIN REQUEST ACCEPT BOT\n━━━━━━━━━━━━━━━━━━━━━━━━━\n● ɪ ᴄᴀɴ ᴀᴜᴛᴏ ᴀᴘᴘʀᴏᴠᴇ ᴜꜱᴇʀꜱ ᴊᴏɪɴ ʀᴇQᴜᴇꜱᴛ ɪɴ ɢʀᴏᴜᴘꜱ ᴀɴᴅ ᴄʜᴀɴɴᴇʟꜱ.\n● ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ᴏʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴘʀᴏᴍᴏᴛᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴡɪᴛʜ ᴘᴇʀᴍɪꜱꜱɪᴏɴꜱ.😊\n\n__Powerd By : #TEAM_Kannada**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard, disable_web_page_preview=True)
